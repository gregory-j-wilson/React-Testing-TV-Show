...
test('render episodes component and see that it receives data', async () => {

    mockFetchShow.mockResolvedValueOnce(showData)

    render(<Episodes episodes={showData.data._embedded.episodes} />)

    const firstEpisodeText = await screen.getByText(/a young boy/i)
    expect(firstEpisodeText).toBeInTheDocument()
